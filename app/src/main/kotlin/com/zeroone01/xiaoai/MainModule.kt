...
import com.zeroone01.xiaoai.hook.MiHealthHook
import com.zeroone01.xiaoai.hook.VoiceAssistHook
    ...
    override fun onPackageLoaded(param: PackageLoadedParam) {
        ...
        try {
            ...
            when (param.packageName) {
                TARGET_MI_HEALTH -> {
                    MiHealthHook(this, cfg, classLoader).install()
                    // 「我的」页入口注入已整体移除：不再向宿主注入任何入口，
                    // 打开设置页只走模块自己的桌面图标。
                }
