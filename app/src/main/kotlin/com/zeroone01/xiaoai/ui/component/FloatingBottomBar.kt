...
package com.zeroone01.xiaoai.ui.component
...
import com.zeroone01.xiaoai.ui.component.animation.DampedDragAnimation
import com.zeroone01.xiaoai.ui.component.animation.InteractiveHighlight
import com.zeroone01.xiaoai.ui.component.liquid.InnerShadow
import com.zeroone01.xiaoai.ui.component.liquid.innerShadow
import com.zeroone01.xiaoai.ui.component.liquid.lens
import com.zeroone01.xiaoai.ui.component.liquid.rememberCombinedBackdrop
import com.zeroone01.xiaoai.ui.component.liquid.vibrancy
...
fun FloatingBottomBar(
    ...
    val dampedDragAnimation = remember(animationScope, tabsCount, density, isLtr) {
        DampedDragAnimation(
            ...
            onDragStopped = {
                ...
                // 拖拽结束才需要把手环页同步到 pager；pager 滚动回调不再反向触发 onSelected，
                // 否则 animateScrollToPage 中间页（2→1→0 的 1）会与目标页动画竞争，停错页。
    ...
    LaunchedEffect(dampedDragAnimation) {
        // 只同步指示器动画，不回调 onSelected：pager → bar 是单向视觉同步，
        // 反向 onSelected 会在翻页动画中途再触发 animateScrollToPage，造成跳页 bug。
